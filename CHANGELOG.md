...
- Prominent official OpenClaw references in `README.md` and `docs/QUICK-START-INSTALLATION.md`
...
### Added
- Project documentation: `README.md`; `docs/QUICK-START-INSTALLATION.md`,
